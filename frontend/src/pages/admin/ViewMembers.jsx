    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f0f] via-[#121212] to-black text-gray-200 p-8">
      ...
      hover:bg-blue-500/25 hover:text-blue-300 transition"
                ...
                <button
                  ...
                  onClick={closeModal}
                  className="
    w-full px-4 py-2 rounded-full text-sm font-semibold
    bg-red-500/20 text-red-400
    border border-red-500/40 hover:bg-red-500/30 hover:text-red-300
    transition
      ...
      {isEditModalOpen && (
        ...
        >
          <div className="bg-[#181818] border border-white/10 rounded-2xl p-6 w-full max-w-2xl shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            hover:bg-yellow-500/25 hover:text-yellow-300
            transition mt-4 w-full
          "
              >
                Save Changes
              </button>
              <button type="button" onClick={closeEditModal} className="col-span-1 sm:col-span-2 w-full px-4 py-2 rounded-full  text-sm font-semibold bg-red-500/20 text-red-400  border border-red-500/40 hover:bg-red-500/30  hover:text-red-300 transition" > Close
              </button>
            </form>
          </div>
        </div>
