...
const MemberInvoicePreview = () => {
  ...
  const fetchInvoice = async () => {
    try {
      const res = await axios.get(`/api/member/invoice/${invoiceId}`);
      if (res.data.success) {
    ...
    <div className="min-h-screen bg-gray-50 flex justify-center py-10 px-4">
      <div className="bg-white w-full max-w-md shadow-md rounded-lg p-6 relative">
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          <a
            href={`/api/member/invoice/${invoice._id}/download`}
...
export default MemberInvoicePreview;